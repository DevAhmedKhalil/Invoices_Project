...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير الغير المدفوعة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/     قائمة الفواتير الغير المدفوعة</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="note" class="form-control" rows="3" placeholder="أدخل ملاحظاتك هنا..."></textarea>
                                </div>
                            </div>
